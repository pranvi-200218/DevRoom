...
.dr-landing{
  ...
  --dr-mono:'Spline Sans Mono', monospace; --dr-sans:'Schibsted Grotesk', sans-serif;
...
.dr-logo{ display:flex; align-items:center; gap:9px; font-family:var(--dr-mono); font-weight:700; font-size:15px; letter-spacing:0.02em; }
.dr-chev{ color:var(--dr-cyan); }
.dr-nav-links{ display:flex; gap:34px; font-family:var(--dr-mono); font-size:13px; color:var(--dr-text-dim); }
...
.dr-signin{ font-family:var(--dr-mono); font-size:13px; color:var(--dr-text-dim); }
.dr-btn{ font-family:var(--dr-mono); font-size:13px; font-weight:600; padding:10px 18px; border-radius:7px; display:inline-flex; align-items:center; gap:8px; }
...
.dr-term-bar{ display:flex; align-items:center; gap:10px; padding:12px 16px; background:var(--dr-panel-2); border-bottom:1px solid var(--dr-line); font-family:var(--dr-mono); font-size:12px; color:var(--dr-text-faint); }
.dr-term-dot{ width:10px; height:10px; border-radius:50%; }
.dr-term-body{ padding:22px 20px; font-family:var(--dr-mono); font-size:13px; line-height:1.85; }
...
.dr-stat-num{ font-family:var(--dr-mono); font-size:34px; font-weight:700; color:var(--dr-cyan); }
.dr-stat-label{ font-family:var(--dr-mono); font-size:12px; color:var(--dr-text-faint); margin-top:6px; }
...
.dr-sec-eyebrow{ font-family:var(--dr-mono); font-size:12px; color:var(--dr-cyan); letter-spacing:0.08em; margin-bottom:16px; }
